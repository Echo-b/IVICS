...
void NRF24L01_Init(void)
{
    ...
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_1 | GPIO_Pin_8; // PA8 1 推挽
    ...
    GPIO_ResetBits(GPIOA, GPIO_Pin_1 | GPIO_Pin_8); // PG6,7,8上拉
...
void NRF24L01_SetTXAddr(u8 *addr)
{
    u8 i;
...
void NRF24L01_SetRXAddr(u8 *addr)
{
    u8 i;
