...
//引脚连接 ：CSN->PA12（PG7）  CE->PB15（PG8）  SCK->PA11（PB13）  MOSI->PA10（PB15）  MISO->PA9（PB14）  IRQ->PA8(PG6)
#define CSN_1 GPIO_SetBits(GPIOG, GPIO_Pin_7);
#define CSN_0 GPIO_ResetBits(GPIOG, GPIO_Pin_7);
#define CE_1 GPIO_SetBits(GPIOG, GPIO_Pin_8);
#define CE_0 GPIO_ResetBits(GPIOG, GPIO_Pin_8);
